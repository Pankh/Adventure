...
while($row1 = mysql_fetch_array($result1))
  ...
  echo " Posted by:<font color=#1d3162> {$row1['FirstName']}"."&nbsp;{$row1["LastName"]}</font>";
	...
	{
	echo'<a class="style" href="deletepost1.php?id=' . $row["comment_id"] . '"">delete</a>&nbsp;&nbsp;<a class="style" href="like.php?id=' . $row["comment_id"] . '"">Like</a>';
	echo "".$row1['final']."";
	echo'&nbsp;&nbsp;<a id="asd" class="style" href="postcom.php">comment</a>&nbsp';
	//echo "".$row1['final']."";
	}

	//echo'<a class="style" href="deletepost.php?id=' . $row["comment_id"] . '">delete</a>&nbsp;&nbsp;<a class="style" href="deletepost.php?id=' . $row["comment_id"] . '"><img width=20 height=20  src=img/like.png>Like</a>&nbsp;&nbsp;<a class="style" href="">Comment</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
